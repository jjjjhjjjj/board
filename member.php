...
function check_input()
{
   ...
   if(!check) {
   	return false;
		...
		$userid =  document.member_form.userid.value //암호화;
		
		$password = 'password string';
		$plainText = document.member_form.userid.value;
		$password = 'password string';
	...
	<div class="all">
		...
		<div class="table6">
			...
			<form id="member_form" name="member_form" method="post"
				action="member_en.php" enctype="multipart/form-data">
					...
					<TABLE border='0' width='650' cellpadding='2' cellspacing='2'>
						...
						<tr>
							...
							<td><select class="center_input" class="hp" name="hp1">
								...
								onkeyup='removeChar(event)'> - <input type="text" class="hp"
								name="hp3" size='6' onKeyPress="return numkeyCheck(event)"
						...
						<tr>
							...
							<td><input type="text" id="sample4_postcode"
								...
								name="sample4_detailAddress" placeholder="상세주소"></td>
							<script
